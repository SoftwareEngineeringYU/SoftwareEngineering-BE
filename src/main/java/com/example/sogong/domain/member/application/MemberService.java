package com.example.sogong.domain.member.application;

import com.example.sogong.domain.member.dao.MemberRepository;
...
public class MemberService
{
    ...
    public ResponseEntity<Page<OrderResponseDto>> getPurchasedProducts(Long memberId, int page, int size, String sort) {
        ...
        return memberRepository.findOrdersByMemberId(memberId, pageable).map(OrderResponseDto::new);
    }
    ...
    public ResponseEntity<Page<ReviewResponseDto>> getWrittenReviews(Long memberId, int page, int size, String sort) {
        ...
        return memberRepository.findReviewsByMemberId(memberId, pageable).map(ReviewResponseDto::new);
    }
}
